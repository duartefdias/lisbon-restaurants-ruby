class RestaurantsController < ApplicationController
    def index
        ...
        categories = [
            {"name" => "Italian", "image_url" => "https://upload.wikimedia.org/wikipedia/commons/8/86/Pizza_%281%29.jpg"},
            ...
            {"name" => "Tapas&Snacks", "image_url" => "https://media.istockphoto.com/photos/spanish-food-tapas-still-life-picture-id1130657473?k=6&m=1130657473&s=612x612&w=0&h=smbKy20HleMyeKeJeUZXWyLvsyN6-vZJbWqUthdxfMs="},
